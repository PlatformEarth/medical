...
(lib.breath = function() {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("Ai0J1Qj4l1BUm5QAwj8CLi/ADhFhQiJjQAuj2QAciOBPhrAFhEKQhnicAii4QAWhsA8hRAAuHaQixkTA+lFQAljBBsiS");
	this.shape.setTransform(-75.2,-1.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.rf(["#FFFFFF","#CF5A9A"],[0.824,1],66.3,2.3,0,66.3,2.3,83.7).s().p("AiSiCQAljBBtiSICjBzQhPBrgbCOQgvD2CJDQIiwB5QizkTA+lFg");
	this.shape_1.setTransform(-67.4,-1.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.rf(["#FFFFFF","#CF5A9A"],[0.824,1],88,1.9,0,88,1.9,111.5).s().p("AjHi5QAwj8CMi/IDoCjQhtCSglDBQg+FFCzETIjiCbQj5l2BUm4g");
	this.shape_2.setTransform(-89.7,-1.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.rf(["#FFFFFF","#CF5A9A"],[0.824,1],23.8,1,0,23.8,1,47.1).s().p("AjYhLQAVhsA9hRIFJDnIAfAqIl2EAQhnicAji4g");
	this.shape_3.setTransform(-24.9,-1.4);
	...
	this.shape_4.setTransform(-50.7,-1.4);

	this.addChild(this.shape_4,this.shape_3,this.shape_2,this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-112.8,-65.4,110.6,127.9);
...
(lib.loop1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY:0.9,y:-3.7},50,cjs.Ease.get(1)).wait(8).to({scaleY:1,y:3.3},51,cjs.Ease.get(1)).wait(11));
	...
	// lungs
	this.instance_2 = new lib.lungs();
	this.instance_2.setTransform(5.5,55.5,1,1,0,0,0,108.7,90.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleY:0.9,y:46},50,cjs.Ease.get(1)).wait(8).to({scaleY:1,y:55.5},51,cjs.Ease.get(1)).wait(11));

	// lungs
	this.instance_3 = new lib.diaphram();
	this.instance_3.setTransform(7.5,153.4,1,1,0,0,0,100.5,21.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleY:1.41,y:144.4},50,cjs.Ease.get(1)).wait(8).to({scaleY:1,y:153.4},51,cjs.Ease.get(1)).wait(11));
	...
	this.instance_5.setTransform(-79.6,-103.2,0.071,0.025,0,0,0,-58.8,-2);
	this.instance_5.alpha = 0.488;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:-58.4,regY:-1.1,scaleX:1.15,scaleY:0.81,x:-148.3,y:-102.5,alpha:0},50,cjs.Ease.get(1)).wait(8).to({regX:-58.8,regY:-2,scaleX:0.07,scaleY:0.03,x:-79.6,y:-103.2,alpha:0.488},51,cjs.Ease.get(1)).to({_off:true},1).wait(10));
