...
(lib.breathing = function(mode,startPosition,loop) {
	...
	this.instance_4.setTransform(390.9,215.3,1,1,0.5,0,0,101,128);
	...
	this.instance_6.setTransform(405,260.7,1,1,0,0,0,119.8,260.7);
...
(lib.person = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(299.2,225.1,0.878,0.79,0,0,0,109.5,3.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:109.6,scaleX:0.99,scaleY:0.99,x:299.3,y:225.6},59,cjs.Ease.get(1)).wait(21).to({regX:109.5,scaleX:0.88,scaleY:0.79,x:299.2,y:225.1},59,cjs.Ease.get(1)).wait(1));
