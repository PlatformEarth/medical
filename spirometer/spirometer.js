...
(lib.spirometer = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.11,scaleY:1,x:376.2,y:304.9},75,cjs.Ease.get(1)).to({scaleX:0.9,scaleY:0.87,x:381.7,y:294.5},74,cjs.Ease.get(1)).wait(1));

	// thorax
	this.instance_1 = new lib.thorax();
	this.instance_1.setTransform(378,226.4,1,0.949,-10.2,0,0,101,128);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:128.1,scaleY:1,rotation:3.5,x:386.8,y:220.2},75,cjs.Ease.get(1)).to({regY:128,scaleY:0.95,rotation:-10.2,x:378,y:226.4},74,cjs.Ease.get(1)).wait(1));

	// body
	this.instance_2 = new lib.body();
	this.instance_2.setTransform(367,747.3,0.928,1,0,0,0,111.2,543.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:1,x:360,y:747.7},75,cjs.Ease.get(1)).to({scaleX:0.93,x:367,y:747.3},74,cjs.Ease.get(1)).wait(1));

	// arm shading
	this.instance_3 = new lib.arm();
	this.instance_3.setTransform(350.8,386.7,1,1,-23.6,0,0,129.2,236.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:129,rotation:-8.4,x:318,y:365.6},75,cjs.Ease.get(1)).to({regX:129.2,rotation:-23.6,x:350.8,y:386.7},74,cjs.Ease.get(1)).wait(1));

	// head
	this.instance_4 = new lib.head();
	this.instance_4.setTransform(403.6,272.4,1,1,-11.7,0,0,119.8,260.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:119.7,regY:260.6,rotation:3.5,x:398,y:267.4},75,cjs.Ease.get(1)).to({regX:119.8,regY:260.7,rotation:-11.7,x:403.6,y:272.4},74,cjs.Ease.get(1)).wait(1));
...
(lib.spiro = function() {
	...
	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,0,0,4).p("");
	...
	this.shape_3.graphics.f().s("#000000").ss(2,0,0,4).p("");
	this.shape_3.setTransform(55,65.3,1.341,1.341,4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#EADBFD").s().p("AiZHhIjNhIQgYgQgCgbIABg3QAAgaAYiVIAijDQAKg5AjiCQACgHgDgHQgDgIgIgCIgFgEQgNgKgBgxQgBgkAFgoQABgGAEgFQAFgFAHgBIANgCQAJgBAFgIIAIgMIAbgNQAzgNB6gHQB4gGAvATQAYAJgBALIAFAKIDhgDQAbAmgKA9QgEAfgKAXIjKAHQgHAAgGAFQgFAGgBAHQgGBGgwDYQgYBugaBtQgDAPg7BiQg1BVgVAeQgKAPgaAAg");
	this.shape_4.setTransform(55,65.3,1.341,1.341,4);
