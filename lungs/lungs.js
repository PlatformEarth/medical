...
(lib.loop1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY:0.9,y:-3.7},49,cjs.Ease.get(1)).wait(10).to({scaleY:1,y:3.3},50,cjs.Ease.get(1)).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleY:0.9,y:46},49,cjs.Ease.get(1)).wait(10).to({scaleY:1,y:55.5},50,cjs.Ease.get(1)).wait(11));

	// lungs
	this.instance_3 = new lib.diaphram();
	this.instance_3.setTransform(7.5,153.4,1,1,0,0,0,100.5,21.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleY:1.41,y:144.4},49,cjs.Ease.get(1)).wait(10).to({scaleY:1,y:153.4},50,cjs.Ease.get(1)).wait(11));
